...
import case_3 from '../../homePageAssets/case3.jpg'
                ...
                <div className="row py-5 w-100 m-0">
                    <div className="col-lg-6 col-md-12 position-relative d-flex align-items-center">
                        <div className='ColSide_imgBox'> 
                            <img src={case_3} className='w-100 rounded ColSide_img' alt=""  /> 
                        </div>
                    ...
                    <div className="col-lg-6 col-md-12 d-flex flex-column justify-content-center">
                        <div className='AboutInfo_box'>
                            ...
                            <h2 className='sub_titles titleFont_style py-3'>Aspire Adventures</h2>
                            <p className='text text_color py-2 pe-4'>The Aspire Adventures is one of the leading projects of Elite Techlogix. 
                                It is one of the leading multi-purpose Easol CMS themes that has been developed to increase your conversion with 
                                the help of our smart ad spaces and SEO-friendly layout. Improved Earnings<br/>
                                Aspire Adventures gives you robust ad management which allows you to earn more money in a less period of
                                time. Aspire Adventures essentially is the % of ads that are clicked per impression.
                            </p>
